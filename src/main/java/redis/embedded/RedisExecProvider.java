...
public class RedisExecProvider {
    ...
    private void initExecutables() {
        ...
        executables.put(OsArchitecture.UNIX_x86_64, "redis-server-5.0.3");

        executables.put(OsArchitecture.MAC_OS_X_x86, "redis-server-5.0.3.app");
        executables.put(OsArchitecture.MAC_OS_X_x86_64, "redis-server-5.0.3.app");
    }
